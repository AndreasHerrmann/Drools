package de.hdm.ordermanager.jersey;
...
import de.hdm.ordermanager.jersey.order.Item;
import de.hdm.ordermanager.jersey.order.Order;

@Path("/")
public class OrderManager{
	private String baseURI = "http://localhost:8080/OrderManagerJersey/jersey";
